...
receiver 설정에 대한 자세한 내용은 Toast Cloud Push에서 제공하는 “Client SDK Guide” 문서를 참고하세요. 
...
다음으로 Toast Cloud Push SDK에서 제공하는 register 메서드에서 인자로 설정했던 사용자 ID 정보를 GameAnalytics.tracePushUserId 메서드의 인자로 설정하여 호출해 주어야 합니다. register 메서드에 대한 자세한 내용은 Toast Cloud Push에서 제공하는 “Client SDK Guide” 문서를 참고하세요. 
