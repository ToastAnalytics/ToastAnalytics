...
**1. 트래킹URL발급**
 ...
 (1) 트래킹URL발급   (2) 채널등록   (3) 광고대행사등록   (4) Postback 설정   
...
② MAT 앱ID 확인
: MAT에서 발급한 앱ID 확인 후 Analytics에 앱ID를 등록합니다. (Analytics > 앱설정 > 마케팅 > 광고대행사등록)
...
#### 4) Postback 설정  
Analyics에 광고대행사를 연동하기 위해 각 광고대행사 사이트에 접속하여 캠페인을 설정합니다. 광고대행사에 Postback URL, Analytics에 앱ID를 등록하면 각 광고대행사를 통해 유입되는 로그가 수집됩니다.  
...
AOS이외의 스토어인 경우 이용자를 트래킹할 수 있는 레퍼러와 같은 고유 식별자를 제공하지 않습니다.  
...
* 매출 : 유료상품을 구매한 금액									
* ARPU : 조회기간 동안 게임 실행 이용자의 인당 평균 구매금액 (Average Revenue Per User)	
...
* 재구매PU비율 : 유료상품을 구매한 이용자 중 재구매한 이용자 비율 (Repurchase Ratio)			
* ARPU : 조회기간 동안 게임 실행 이용자의 인당 평균 구매금액 (Average Revenue Per User)			
* ARPDAU : 게임 실행 이용자의 인당 일평균 구매금액 (Average Revenue Per Daily Active User)				
