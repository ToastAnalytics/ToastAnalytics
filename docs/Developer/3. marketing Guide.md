...
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing1.png)
...
![ 트래킹 URL발급 팝업1]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing2.png)

[ 트래킹 URL발급 팝업1]

![ 트래킹 URL 확인 팝업2]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing3.png)
...
![Facebook 트래킹 Flow]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing3_1.png)

**(1) 딥링크 발급

![딥링크 발급]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing3_2.png)
...
![딥링크 확인]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing3_3.png)
...
※ 정상적으로 호출되면 callback이 오는데, allback에 정상적으로 Deeplink URL이 담겨 있는지 확인이 필요합니다.
...
![Tap to launch your Deep Link]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing3_14.png)
...
![ 채널추가 팝업]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing4.png)
...
![ 채널등록 테이블]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing5.png)
...
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing6.png)
...
![ 트래킹이벤트 추가 팝업]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing16.png)
...
![ 이벤트선택 셀렉박스]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing17.png)
...
![ Postback 등록]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing17_1.png)
...
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing17_2.png)

[ Postback 등록 > Partner 템플릿 추가 팝업]

![ Postback 등록 > 직접등록 추가 팝업]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing17_3.png)

[ Postback 등록 > 직접등록 추가 팝업]

![ Postback 등록 확인]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing17_4.png)
...
![  마케팅 채널별 실시간 유입현황 ]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing18.png)
...
![ 채널별 재방문율 비교 차트]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing22.PNG)
...
![ 채널별 ARPU 비교 차트]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing23.PNG)
...
![ 채널별 레벨 Funnel 비교 차트]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing24.PNG)
...
![ 채널별 이벤트 현황]
(https://raw.githubusercontent.com/ToastAnalytics/ToastAnalytics/master/docs/Developer/images/marketing25.png)
