...
예를 들어, (Push, click, param1,param2, value, level) / (popup, click, param1, param2, value, level)로 적용하는것보다는 
(Push, push_click, param1, param2, value, level) / (popup, popup_click, param1, param2, value, level)을 권장드립니다.
